...
const commercialHubConfig: HubConfig = {
  ...
  services: [
    ...
    },
    {
      ...
      description: 'Bulky items, business clutter, and commercial debris removed on schedule.',
      to: '/commercial-junk-removal',
    },
    {
      icon: Briefcase,
      title: 'Office Cleanouts',
      description: 'Office furniture, files, cubicles, equipment, and general contents removed.',
      to: '/office-cleanouts',
    },
    {
      icon: Archive,
      title: 'Office Furniture Removal',
      description: 'Desks, chairs, cabinets, conference tables, and workstations removed.',
