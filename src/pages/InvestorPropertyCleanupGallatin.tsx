...
import { ArrowLeft, CheckCircle2, ClipboardCheck, MapPin, MessageSquare, Phone, Truck } from 'lucide-react';
      ...
      <section data-hide-sticky-cta className="bg-brand-navy py-20 text-white">
        <div className="mx-auto max-w-5xl px-6 text-center">
          <h2 className="mb-5 font-display text-4xl font-bold lg:text-5xl">
            Need a property cleared before the next phase?
          </h2>
          <p className="mx-auto mb-8 max-w-2xl text-lg leading-relaxed text-slate-300">
            Text photos for a fast quote on investor cleanups, debris removal, fence demo, and property preparation.
          </p>
          <div className="flex flex-col justify-center gap-4 sm:flex-row">
            <a
              href="sms:6152000064?body=Hi%2C%20I%27d%20like%20a%20fast%20quote%20for%20an%20investor%20property%20cleanup"
