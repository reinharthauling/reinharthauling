        ...
        <div className="mx-auto max-w-7xl px-6 text-center">
          <div className="mx-auto max-w-4xl">
            <h2 className="mb-6 font-display text-4xl font-bold leading-tight text-brand-navy lg:text-5xl">
              Ready to prepare your property for renovation?
            </h2>
            <p className="mx-auto mb-10 max-w-2xl text-lg leading-relaxed text-slate-600">
              Text project photos for a demo quote, call to discuss tear-out scope, or request an on-site walkthrough
              for larger selective demolition projects.
            </p>
